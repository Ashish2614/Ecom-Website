            ...
            <form onSubmit={postData}>
              <div className="row">
                ...
                <div className="col-md-12 mb-3">
                  ...
                  <input type="text" name="siteName" value={data.siteName} onChange={getInputData} placeholder='siteName' className='form-control border-primary' />
                </div>
                <div className="col-md-12 mb-3">
                  <label>Email</label>
                  ...
                  <input type="text" name="phone" value={data.phone} onChange={getInputData} placeholder='phone' className='form-control border-primary' />
                </div>
                <div className="col-md-3 mb-3">
                  <label>Whatsapp Number</label>
                  <input type="text" name="whatsapp Number" value={data.whatsapp} onChange={getInputData} placeholder='whatsapp Number' className='form-control border-primary' />
                </div>
                <div className="col-12 mb-3">
