    ...
    <>
      ...
      <div className="container-fluid bg-light overflow-hidden py-5">
        <div className="container py-5">
          <h1 clasNaclassName="mb-4 wow fadeInUp" data-wow-delay="0.1s">Billing details</h1>
          <form action="#">
            <div className="row g-5">
              <div className="col-md-12 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div className="form-item">
                  ...
                  <input type="tel" clasNaclassName="form-control" />
                </div>
                <div className="form-item">
                  <label className="form-label my-3">Email Address<sup>*</sup></label>
                  <input type="email" clasNaclassName="form-control" />
                </div>
                ...
                <div className="form-item">
                  <textarea name="text" clasNaclassName="form-control" spellcheck="false" cols="30" rows="11"
              ...
              <div className="col-md-12 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                <div className="table-responsive">
                  <table className="table">
                    <thead>
                      <tr clasNaclassName="text-center">
                        <th scope="col" clasNaclassName="text-start">Name</th>
                    ...
                    <tbody>
                      <tr clasNaclassName="text-center">
                        <th scope="row" clasNaclassName="text-start py-4">
                          Apple iPad Mini
                        </th>
                        <td clasNaclassName="py-4">G2356</td>
                        <td clasNaclassName="py-4">$269.00</td>
                        <td clasNaclassName="py-4 text-center">2</td>
                        <td clasNaclassName="py-4">$538.00</td>
                      </tr>
                      <tr clasNaclassName="text-center">
                        <th scope="row" clasNaclassName="text-start py-4">
                          Apple iPad Mini
                      ...
                      <tr>
                        ...
                        <td clasNaclassName="py-4"></td>
                        <td clasNaclassName="py-4"></td>
                        <td clasNaclassName="py-4">
                      ...
                      <tr>
                        ...
                        <td colspan="3" clasNaclassName="py-4">
                ...
                <div className="row g-4 text-center align-items-center justify-content-center pt-4">
                  <button type="button"
                    clasNaclassName="btn btn-primary border-secondary py-3 px-4 text-uppercase w-100 text-primary">Place
                    Order</button>
                </div>
              </div>
            </div>
